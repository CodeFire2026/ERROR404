    ...
    public class HolaMundo4 {
      ...
      // Al principio del video el profesor tenía un Hola Mundo común:
       ...
       Scanner entrada = new Scanner(System.in);
        ...
        //Acá usamos numEnteroByte2 (que no estaba repetida) usando el Scanner que sigue ABIERTO
        // 1. Guardamos lo que se escribe en la variable 2
        byte numEnteroByte2 = entrada.nextByte();
        
        // 2. Acá le agregamos el '2' para usarla y que se vaya la línea amarilla
        System.out.println("Tu numero en Byte es = " + numEnteroByte2);
        System.out.println("Valor minimo del Byte: " + Byte.MIN_VALUE);
        System.out.println("Valor maximo del Byte: " + Byte.MAX_VALUE);

        // Tipo short (Reasignamos sin poner la palabra 'short' adelante)
        numEnteroShort = 32767;
        System.out.println("numEnteroShort = " + numEnteroShort);
        System.out.println("Valor minimo del Short: " + Short.MIN_VALUE);
        System.out.println("Valor maximo del Short: " + Short.MAX_VALUE);

        // Tipo int (Reasignamos sin poner la palabra 'int' adelante)
        numEnteroInt = 2147483647;
        System.out.println("numEnteroInt = " + numEnteroInt);
        System.out.println("Valor minimo del int: " + Integer.MIN_VALUE);
        System.out.println("Valor maximo del int: " + Integer.MAX_VALUE);

        // Tipo long (Reasignamos sin poner la palabra 'long' adelante)
        numEnteroLong = 10;
        System.out.println("numEnteroLong = " + numEnteroLong);
        System.out.println("Valor minimo del long: " + Long.MIN_VALUE);
        System.out.println("Valor maximo del long: " + Long.MAX_VALUE);
